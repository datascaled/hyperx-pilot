...
HyperX Pilot is a lightweight Tauri + Vue desktop companion for HyperX headsets. The initial release targets the HyperX Cloud III (wired) and focuses on sidetone control without requiring HyperX NGenuity.
